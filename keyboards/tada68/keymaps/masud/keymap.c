...
KC_LCTL, KC_LGUI, KC_LALT,              KC_SPC,                KC_RALT, MO(2),   KC_RCTRL, KC_LEFT, KC_DOWN, KC_RGHT),
...
_______, KC_GLHF, KC_UP,   _______,  _______, _______, _______, _______, _______, _______, _______, _______, KC_PAUS, KC_SLCK, KC_HOME, \
